...
int main() {
    ...
    // -------------------------
    Shader shader("resources/6.1.cubemaps.vs.glsl",
                  "resources/6.1.cubemaps.fs.glsl");
    Shader skyboxShader("resources/6.1.skybox.vs.glsl",
                        "resources/6.1.skybox.fs.glsl");
