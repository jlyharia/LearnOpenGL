...
int main() {
    ...
    // -------------------------
    Shader shader("resources/6.2.cubemaps.vs.glsl",
                  "resources/6.2.cubemaps.fs.glsl");
    Shader skyboxShader("resources/6.2.skybox.vs.glsl",
                        "resources/6.2.skybox.fs.glsl");
