...
int main() {
    ...
    // -------------------------
    Shader shader("resources/5.1.framebuffers.vs.glsl",
                  "resources/5.1.framebuffers.fs.glsl");
    Shader screenShader("resources/5.1.framebuffers_screen.vs.glsl",
                        "resources/5.1.framebuffers_screen.fs.glsl");
