...
int main() {
    ...
    // -------------------------
    Shader shader("resources/3.1.2.shadow_mapping.vs.glsl",
                  "resources/3.1.2.shadow_mapping.fs.glsl");
    Shader simpleDepthShader("resources/3.1.2.shadow_mapping_depth.vs.glsl",
                             "resources/3.1.2.shadow_mapping_depth.fs.glsl");
    Shader debugDepthQuad("resources/3.1.2.debug_quad.vs.glsl",
                          "resources/3.1.2.debug_quad.fs.glsl");
