...
int main() {
    ...
    // -------------------------
    Shader shaderGeometryPass("resources/8.1.g_buffer.vs.glsl",
                              "resources/8.1.g_buffer.fs.glsl");
    Shader shaderLightingPass("resources/8.1.deferred_shading.vs.glsl",
                              "resources/8.1.deferred_shading.fs.glsl");
    Shader shaderLightBox("resources/8.1.deferred_light_box.vs.glsl",
                          "resources/8.1.deferred_light_box.fs.glsl");
