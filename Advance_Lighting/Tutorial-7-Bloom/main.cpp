...
// camera
Camera camera(glm::vec3(-3.0f, 2.0f, 1.0f));
...
int main() {
    ...
    // -------------------------
    Shader shader("resources/7.bloom.vs.glsl",
                  "resources/7.bloom.fs.glsl");
    Shader shaderLight("resources/7.bloom.vs.glsl",
                       "resources/7.light_box.fs.glsl");
    Shader shaderBlur("resources/7.blur.vs.glsl",
                      "resources/7.blur.fs.glsl");
    Shader shaderBloomFinal("resources/7.bloom_final.vs.glsl",
                            "resources/7.bloom_final.fs.glsl");
    ...
    unsigned int containerTexture = loadTexture(std::filesystem::path("resources/textures/container2.png").c_str(),
                                                true); // note that we're loading the texture as an SRGB texture
    ...
    // OpenGL, by default, only renders to a framebuffer's first color attachment, ignoring all others.
