...
int main() {
    ...
    // -------------------------
    Shader shader("resources/4.normal_mapping.vs.glsl",
                  "resources/4.normal_mapping.fs.glsl");

    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture(std::filesystem::path("resources/textures/brickwall.jpg").c_str());
    unsigned int normalMap = loadTexture(std::filesystem::path("resources/textures/brickwall_normal.jpg").c_str());
