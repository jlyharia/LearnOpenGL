...
int main() {
    ...
    // -------------------------
    Shader simpleDepthShader("resources/3.1.1.shadow_mapping_depth.vs.glsl",
                             "resources/3.1.1.shadow_mapping_depth.fs.glsl");
    Shader debugDepthQuad("resources/3.1.1.debug_quad.vs.glsl",
                          "resources/3.1.1.debug_quad.fs.glsl");
    ...
    unsigned int woodTexture = loadTexture(
            std::filesystem::path("resources/textures/wood.png").c_str());
