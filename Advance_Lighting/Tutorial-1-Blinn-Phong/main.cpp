...
int main() {
    ...
    // -------------------------
    Shader shader("resources/advanced_lighting.vs.glsl",
                  "resources/advanced_lighting.fs.glsl");
    ...
    // load textures
    // -------------
    unsigned int floorTexture = loadTexture(std::filesystem::path("resources/textures/wood.png").c_str());
